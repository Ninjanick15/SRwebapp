...
app.post('/create_session', function (req, res) {
    ...
    var sql = "INSERT INTO Growth (datetime, env_id, num_of_leaves, height) VALUES ('" + req.body.datetime + "','" + req.body.env_id + "','" + req.body.numofleaves + "','" + req.body.height + "')";
    con.query(sql, function (err, result) {
        if (err) throw err;
        res.end();
    });
    res.send('<h3>Growth input accepted!</h3><br> <button type="button"><a href="test.html">Back</a></button>');
});
